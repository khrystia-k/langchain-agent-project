...
class RAGPipeline:
    def __init__(self, text_file, vectorstore_file, model_name="gpt-4o-mini", chunk_size=1150, chunk_overlap=150, temperature=0):
        load_dotenv() 
    ...
    def answer(self, query):
        ...
        chain = (
            {"context": self.retriever | RunnableLambda(self.prepare_context), "question": RunnablePassthrough()}
            | prompt
            | self.model
            | StrOutputParser()
        )
